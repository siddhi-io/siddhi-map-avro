...
```
@sink(..., @map(type="avro", schema.def="<STRING>")
```
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">This specifies the desired avro schema to be used to convert siddhi event to avro message.<br>The schema should be specified as a quoted json string.</td>
...
<span id="syntax" class="md-typeset" style="display: block; font-weight: bold;">Syntax</span>
```
@source(..., @map(type="avro", schema.def="<STRING>")
```
